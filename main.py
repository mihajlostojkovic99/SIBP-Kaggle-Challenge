...
X_train_poly, X_test_poly, y_train_poly, y_test_poly = train_test_split(poly_features, y, test_size=0.25, random_state=0)
...
for model, func in models.items():
    ...
    if model == 'Tuned Linear Regression':
        ...
        results.loc[model] = [mean_absolute_error(y_test_poly, pred),
                              mean_squared_error(y_test_poly, pred, squared=False),
